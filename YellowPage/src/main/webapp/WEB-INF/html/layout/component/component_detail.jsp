		...
		<div class="panel-content">
			...
			<ul class="nav nav-tabs flex-shrink-0">
				...
				<li class="nav-item" id="item-result-parent">
					<a class="nav-link" href="#process-result" data-toggle="tab" id="item-result" ><fmt:message>label.executionResult</fmt:message></a>
				</li>
			</ul>
			...
			<footer id="panel-footer" class="panel-footer sub-bar">
				<div class="ml-auto">
                    <a href="javascript:void(0);" id="stopBtn"           class="btn viewGroup"                                style="display: none;"    v-on:click="stop"><i class="icon-pause"></i><fmt:message>label.stop</fmt:message></a>
                    <a href="javascript:void(0);" id="stopForceBtn"    class="btn viewGroup"                               style="display: none;"    v-on:click="stopForce"><i class="icon-x"></i><fmt:message>label.stop.force</fmt:message></a>
                    <a href="javascript:void(0);" id="removeBtn"       class="btn viewGroup removeBtn"                          style="display: none;"    v-on:click="removeInfo"><i class="icon-delete"></i><fmt:message>label.delete</fmt:message></a>
                    <a href="javascript:void(0);" id="goModBtn"        class="btn viewGroup goModBtn"                          style="display: none;"    v-on:click="goModifyPanel"><i class="icon-edit"></i><fmt:message>label.update</fmt:message></a>                        
                    <a href="javascript:void(0);" id="saveBtn"         class="btn btn-primary saveGroup saveBtn"            style="display: none;"    v-on:click="saveInfo"><fmt:message>label.insert</fmt:message></a>
                    <a href="javascript:void(0);" id="updateBtn"       class="btn btn-primary updateGroup updateBtn"       style="display: none;"    v-on:click="updateInfo"><i class="icon-edit"></i><fmt:message>label.update</fmt:message></a>
                    <a href="javascript:void(0);" id="goAddBtn"        class="btn btn-primary viewGroup goAddBtn"          style="display: none;"    v-on:click="goAddInfo" ><i class="icon-plus"></i><fmt:message>label.insert</fmt:message>(<fmt:message>label.copy</fmt:message>)</a>                        
				</div>
			</footer>
...
var panelMethodOption = {
	goPreviousPanel: function() {
   	...
   	removeInfo: function() {
   		SaveImngObj.remove('<fmt:message>msg.alert.delete.warn</fmt:message>', '<fmt:message>msg.alert.delete</fmt:message>');
   	},
   	updateInfo: function() {
   		SaveImngObj.update('<fmt:message>msg.alert.update</fmt:message>');
   	},
   	saveInfo: function() {
   		SaveImngObj.insert('<fmt:message>msg.alert.insert</fmt:message>');
   	},
