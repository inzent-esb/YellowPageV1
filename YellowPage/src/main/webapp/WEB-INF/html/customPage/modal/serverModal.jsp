...
<body>
	...
	$(document).ready(function() {
		...
		createPageObj.setViewName('serverModal');
		...
		var vmList = new Vue({
	        ...
	        mounted: function() {
	        	...
	        	this.makeGridObj.setConfig({
		            ...
		            searchUrl: '/api/entity/server/search',
		            totalCntUrl: '/api/entity/server/count',
		    		paging: {
		    			isUse: true,
		    			side: "server"
		    		},
        ...
        document.querySelector('#serverModal').addEventListener('resize', function(evt) {
